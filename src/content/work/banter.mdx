...
date: 2025
accent: rgb(50, 50, 50)
desc: Getting brand typography compliant.
project: client
roles:
  - Design Systems
...
Leadership ended up moving forward with zeroheight, since it was the leading industry standard at the time (we were still on Sketch) and so the migration began. **I moved all the content from DSM to zeroheight** and created visuals and added illustrations to help it feel more approachable. 
![](/images/Amor_zh.png)
