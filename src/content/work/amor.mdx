...
**Amor is Signet Jeweler's design system, designed to deliver consistent and accessible e-commerce experiences at scale across multiple brands.**
...
### Documentation
DSM was a great starting point for the design system, as it allowed us to get up and running quickly with built-in support for [Storybook](https://storybook.js.org/) and token creation in one platform. However, as we continued building the system, its limited formatting options became a significant challenge. I often struggled to work within these constraints while trying to scale and refine the system.
...
- Designers save approximately 1/3 of their time utilizing the design system, allowing them to focus more on research and other factors. Time savings ranging from 3 to 10+ hours per week.
...
I'm also working with my development counterpart to survey the development team, hopefully gaining more insights on how to improve and evolve Amor.
