...
![](/images/medic_webmd.png) WebMD Symptom Checker: Starts with your age and gender.

</div>
<div>

![](/images/medic_symcat.png) Symcat Home Page/Symptom Checker: Starts with entering a symptom or selecting from their examples list.

</div>
<div>

![](/images/medic_mayoclinic.jpg) Mayo Clinic Symptom Checker: Starts with selecting from a set list of symptoms
...
![](/images/medic_flow.png)

## Testing Scope

![](/images/medic_testing_scope.png)

## The Product

**Ideations and sketches...**

![](/images/medic_sketches.png)
...
![](/images/medic_result1.gif) Users can enter the symptom tracker from the conditions page they enter from with the widget at the top.

</div>
<div>

![](/images/medic_result2.gif) Users can stay on our site to view resources on the condition from other reputable site.

</div>
<div>

![](/images/medic_result3.gif) Results page allows users to make changes or start over if needed. Also allows users to understand their results with a strength key.s
